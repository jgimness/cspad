...
var CodeMirror = (function() {
    ...
    function frameHTML(options) {
        ...
        // @JAG: Push merged script
        html.push("<script type=\"text/javascript\" src=\"/Scripts/CodeMirror.merge\"><" + "/script>");

        forEach(options.parserfile, function(file) {
    ...
    function CodeMirror(place, options) {
        ...
        if ('allowTransparency' in frame) { frame.allowTransparency = true; }
